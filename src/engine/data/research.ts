export type ResearchId = "contractSpeed" | "productionBoost" | "extraContractSlot";
...
export interface ResearchDefinition {
  ...
  effect:
    | { type: "contractSpeed"; multiplier: number }
    | { type: "productionMultiplier"; multiplier: number }
    | { type: "contractSlot"; bonus: number };
}
...
export function findResearchDefinition(id: ResearchId): ResearchDefinition {
